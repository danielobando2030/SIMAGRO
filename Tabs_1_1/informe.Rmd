...
```
<!-- Titulo del tablaro -->
\fontsize{14}{14} \selectfont \textcolor{gray}{Municipios de procedencia de alimentos para Cundinamarca}\
<!-- Subtitulo -->
\fontsize{12}{12} \selectfont \textcolor{gray}{Descubre los principales municipios proveedores de alimentos que ingresan a Cundinamarca según el SIPSA.}\
<!-- Grafica -->
```{r, out.width = "90%",warning=FALSE,message=FALSE}
print(params$plot)
```
\newline
\fontsize{8}{8} \selectfont \textcolor{gray}{\textbf{Fuente:} Cálculos propios a partir de datos del Sistema de Información de Precios y Abastecimiento del Sector Agropecuario (SIPSA).}\
\newline
