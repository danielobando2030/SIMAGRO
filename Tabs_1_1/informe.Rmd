...
```
<!-- Titulo del tablaro -->
\fontsize{14}{14} \selectfont \textcolor{mybrown}{Municipios proveedores de alimentos para Cundinamarca}\
<!-- Subtitulo -->
\fontsize{12}{12} \selectfont \textcolor{mybrown}{Descubre los principales municipios proveedores de alimentos que ingresan a Cundinamarca según el SIPSA.}\
<!-- Grafica -->
...
\fontsize{8}{8} \selectfont \textcolor{mybrown}{Esta visualización muestra el ranking de los municipios de orígen de los alimentos que llegan a las principales centrales de abasto de Bogotá, resaltando su participación porcentual en el volumen total de ingresos.}\
\fontsize{8}{8} \selectfont \textcolor{mybrown}{\textbf{Local:} Productos reportados con origen de territorios del departamento de Cundinamarca.}\
\fontsize{8}{8} \selectfont \textcolor{mybrown}{\textbf{Externo:} Productos reportados con origen fuera del departamento de  Cundinamarca.}\
