...
```
<!-- Titulo del tablaro -->
\fontsize{14}{14} \selectfont \textcolor{mygreen}{Contribución de Cundinamarca al Abastecimiento Nacional}\newline
<!-- Subtitulo -->
\fontsize{12}{12} \selectfont \textcolor{green2}{Análisis de la participación de Cundinamarca en el abastecimiento de alimentos en otros departamentos del país}\newline
<!-- Subtitulo dinamico -->
...
\fontsize{8}{8} \selectfont \textcolor{mygreen}{Los departamentos en color gris indican la ausencia de reportes de ingresos de productos provenientes de Cundinamarca.}\newline
