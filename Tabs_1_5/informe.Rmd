...
```
<!-- Titulo del tablaro -->
\fontsize{15}{15} \selectfont \textcolor{mygreen}{Principales alimentos en centrales de abasto de Bogotá, por volumen de ingreso}\
<!-- Subtitulo -->
\fontsize{12}{12} \selectfont \textcolor{green2}{Visualiza los alimentos más destacados en las centrales de abasto de Bogotá, basado en su volumen de entrada}\
<!-- Subtitulo dinamico -->
...
\fontsize{8}{8} \selectfont \textcolor{mygreen}{Solo se muestran los productos que representan al menos un 0,5\% del volumen total de ingresos a las principales centrales de abasto de Bogotá.}\
