...
```
<!-- Titulo del tablaro -->
\fontsize{14}{14} \selectfont \textcolor{mygreen}{Cundinamarca en los mercados: Principales productos por volumen}\
<!-- Subtitulo -->
\fontsize{12}{12} \selectfont \textcolor{green2}{Principales productos de Cundinamarca en otros mercados: volumen y composición de la 
canasta.}\
<!-- Subtitulo dinamico -->
...
\fontsize{8}{8} \selectfont \textcolor{mygreen}{Solo se muestran los productos que representan al menos un 0,5\% del volumen total de productos de origen cundinamarques reportado en las centrales de abasto del SIPSA.}\
