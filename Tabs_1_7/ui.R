    ...
    fluidRow(
      column(9,
             ...
             tags$div(
               ...
               tags$p(HTML("El balance de alimentos se define como la diferencia en volumen entre los alimentos que ingresan a las principales centrales de abasto de Bogotá con origen en Cundinamarca y el total de alimentos reportados en las centrales. La fórmula para calcular el balance de alimentos es <i>N<sub>it</sub> = P<sub>A</sub> - D<sub>A</sub></i>, donde <i>N<sub>it</sub> es el balance de alimentos, P<sub>A</sub> es el volumen de alimentos que se originan en Cundinamarca y D<sub>A</sub></i> es el volumen total de alimentos que llegan al centro de acopio de Bogotá."), class = "sub-header2", style = "margin-top: 3px;"),
