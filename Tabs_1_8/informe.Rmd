...
<!-- Titulo del tablaro -->
\fontsize{14}{14} \selectfont \textcolor{mygreen}{Análisis de Pareto del flujo de alimentos en Cundinamarca}\
\fontsize{12}{12} \selectfont \textcolor{green2}{Productos principales por volumen en flujo de alimentos en Cundinamarca.}\
<!-- Subtitulo -->
...
\fontsize{8}{8} \selectfont \textcolor{mygreen}{Entradas locales: Productos reportados con origen de territorios del departamento de Cundinamarca.}\
\fontsize{8}{8} \selectfont \textcolor{mygreen}{Entradas externas: Productos reportados con origen fuera del departamento de  Cundinamarca.}\
