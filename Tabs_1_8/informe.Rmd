...
\fontsize{12}{12} \selectfont \textcolor{mybrown}{Visualiza los productos con mayor participación en el abastecimiento de alimentos desde y hacia Cundinamarca}\
<!-- Subtitulo -->
...
\fontsize{10}{10} \selectfont \textcolor{mybrown}{Este gráfico ordena los alimentos por volumen y muestra cómo se acumula el total. La línea vertical marca el punto donde se alcanza cerca del 80\% del volumen acumulado e identifica el alimento que completa ese porcentaje. Así, permite ver cuántos productos concentran la mayor parte del volumen en el periodo seleccionado y la importancia de cada uno en las entradas y salidas de alimentos de Cundinamarca.}\
