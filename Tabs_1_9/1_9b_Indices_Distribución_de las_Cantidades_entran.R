...
Texto=paste0("En el año ",max(as.numeric(as.character(BD$var1)))," se puede observar que en el 25% de los meses se alcanza un volumen de alimentos menor o igual a ",format(round(S$q1),decimal.mark=",",big.mark=".")," Toneladas",
            ". En el 50% de los meses se alcanza un volumen menor o igual a ",format(round(S$mediana),decimal.mark=",",big.mark="."),
            ". En el 75% de los meses alcanza un volumen menor o igual a  ",format(round(S$q3),decimal.mark=",",big.mark="."))
  # --- 8. Retorno ---
  return(list(
    grafico_plano = graf,
