...
```
<!-- Titulo del tablaro -->
\fontsize{14}{14} \selectfont \textcolor{mygreen}{Distribución de la cantidad de productos que entran a Bogotá}\
<!-- Subtitulo -->
\fontsize{12}{12} \selectfont \textcolor{green2}{Descubre cómo se comporta la cantidad mensual de productos que entrán a Bogotá según el SIPSA.}\
<!-- Grafica -->
