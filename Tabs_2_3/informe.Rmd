...
```
<!-- Titulo del tablaro -->
\fontsize{14}{14} \selectfont \textcolor{mygreen}{Índice de diversidad de alimentos}\
<!-- Subtitulo -->
\fontsize{12}{12} \selectfont \textcolor{green2}{Análisis de variedad de los alimentos que ingresan a las principales centrales de abasto de Cundinamarca.}\
<!-- Subtitulo dinamico -->
...
\fontsize{8}{8} \selectfont \textcolor{mygreen}{La fórmula del índice de Herfindahl-Hirschman es: $IHH = \sum_{i=1}^{n}S_{i}^{2}$ donde $S_{i}$ es la participación que tiene cada producto en el volumen total de alimentos que ingresan a las principales centrales de abasto de Cundinamarca.}\newline
