...
```
<!-- Titulo del tablaro -->
\fontsize{14}{14} \selectfont \textcolor{mybrown}{Índice de diversidad de origen de los alimentos}\
<!-- Subtitulo -->
...
\fontsize{8}{8} \selectfont \textcolor{mybrown}{La fórmula del índice de Herfindahl-Hirschman es: $\sum_{i=1}^{n} S_{i}^2$ donde $S_{i}$ es la participación que tiene cada origen en el total de volumen de alimentos que ingresan a las centrales.}\newline
