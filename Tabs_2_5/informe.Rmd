...
\fontsize{8}{8} \selectfont \textcolor{mygreen}{Este gráfico se calcula con base en índice de Herfindahl-Hirschman.}\newline
\fontsize{8}{8} \selectfont \textcolor{mygreen}{La fórmula del índice de Herfindahl-Hirschman es $IHH = \sum_{i=1}^{n} S_{i}^{2}$ donde $S_{i}$ es la participación que tiene cada municipio (origen) en el total de volumen de alimentos que ingresan.}\newline
