...
```
<!-- Titulo del tablaro -->
\fontsize{14}{14} \selectfont \textcolor{mybrown}{Índice Gini de diversidad de origen de los alimentos}\
<!-- Subtitulo -->
\fontsize{12}{12} \selectfont \textcolor{mybrown}{Análisis de la variedad de territorios conectados por el flujo de alimentos desde su origen hasta los pricipales centros de abasto de Cundinamarca.}\
<!-- Subtitulo dinamico -->
\fontsize{10}{10} \selectfont `r params$subtitulo`\
```{r, out.width = "95%", fig.height=4, fig.align = "center", warning=FALSE}
print(params$plot)
```
...
\fontsize{8}{8} \selectfont \textcolor{mybrown}{La fórmula del índice de Gini es: $G = 1 - \sum_{i=1}^{n} (X_{i} - X_{i-1})(Y_{i} + Y_{i-1})$, donde $X_{i}$ representa el porcentaje acumulado de municipios (ordenados de menor a mayor participación) y $Y_{i}$ el porcentaje acumulado del volumen total de alimentos que ingresan a las centrales.}
\newline
