...
```
<!-- Titulo del tablaro -->
\fontsize{14}{14} \selectfont \textcolor{mygreen}{Índice de diversidad de destino de los alimentos}\
<!-- Subtitulo -->
\fontsize{12}{12} \selectfont \textcolor{green2}{Análisis de la variedad de territorios conectados por el flujo de alimentos desde Cundinamarca hacia otras plazas en SIPSA.}\
<!-- Subtitulo dinamico -->
...
\fontsize{8}{8} \selectfont \textcolor{mygreen}{Este gráfico se calcula con base en el índice de Gini.}\newline
\fontsize{8}{8} \selectfont \textcolor{mygreen}{La fórmula del índice de Gini es 
