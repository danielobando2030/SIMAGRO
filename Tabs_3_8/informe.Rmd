...
\textcolor{grayA}{\textbf{Correlaciones más altas: }`r escape_textcolor(params$mensaje_altas)`}
\endgroup


\begingroup
\fontsize{10}{12}\selectfont
\textcolor{grayA}{\textbf{Correlaciones más bajas: }`r escape_textcolor(params$mensaje_bajas)`}
\endgroup
