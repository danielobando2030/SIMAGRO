---
title: "Huella de carbono por grupo y producto"
params:
  datos: NA
  resumen: NA
  mensaje1: NA
...
\textcolor{gray}{Este informe presenta la distribución de la huella de carbono (en toneladas de CO₂) asociada al transporte y abastecimiento de productos agropecuarios durante el período seleccionado. El gráfico tipo *treemap* muestra la participación relativa de cada grupo y producto dentro del total de emisiones estimadas.}

\medskip

\textcolor{green2}{`r if (!is.null(params$mensaje1)) params$mensaje1 else ""`}
...
\textcolor{gray}{Los grupos en tonos más oscuros representan mayor peso en la huella total, mientras que los tonos claros corresponden a productos de menor participación. Los valores incluyen estimaciones por transporte, volumen y distancia promedio recorrida.}
